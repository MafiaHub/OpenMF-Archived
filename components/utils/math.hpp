...
/*  This file has been forked from linalg.h v2.0.  */
...
#include <cstdint>      // For implementing namespace aliases
...
namespace MFMath
{
    ...
    // identity is a constant which can be assigned to any square matrix type
    struct identity_t
    {
